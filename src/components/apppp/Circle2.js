...
import './AppTwo.css'; // Import your CSS file for styling
...
const CircleTwo = () => {
  ...
  const circles = Array.from({ length: 8 }, (_, index) => {
    ...
    return (
      ...
      >
        ...
        {index == 6 ? <p className='text-white lg:text-sm lg:-mt-2 md:-mt-2 -mt-6 -mt-6 text-center' style={{fontSize:'8px'}} >1.<br /> Identify Opportunity</p> : ''}
        {index == 7 ? <p className='text-white  lg:-mt-2 md:-mt-2  -mt-4 text-center' style={{fontSize:'7px'}}>2.<br /> Create your Blueprint</p> : ''}
        {index == 0 ? <p className='text-white  lg:-mt-2 md:-mt-2  -mt-4 text-center' style={{fontSize:'8px'}}>3.<br /> Extract your Data</p> : ''}
        {index == 1 ? <p className='text-white  lg:-mt-2 md:-mt-2  -mt-4 text-center' style={{fontSize:'8px'}}>4.<br /> Enhance your Data</p> : ''}
        {index == 2 ? <p className='text-white  -mt-6 -mt-6 text-center' style={{fontSize:'7px'}}>5.<br /> Implement your Algorithm</p> : ''}
        {index == 3 ? <p className='text-white  lg:-mt-2 md:-mt-2 -mt-4 text-center' style={{fontSize:'8px'}}>6.<br /> Establish Confidence</p> : ''}
        {index == 4 ? <p className='text-white   -mt-4 text-center' style={{fontSize:'8px'}}>7.<br /> Go Live</p> : ''}
        {index == 5 ? <p className='text-white  lg:-mt-2 md:-mt-2 -mt-4 text-center' style={{fontSize:'8px'}}>8.<br /> Refine and Repeat</p> : ''}
        </div>
      </div>
    );
  });
  ...
  return (
    <div className="main-circle" onMouseLeave={handleLeave}>
      ...
      {circles}
      {hoveredIndex !== null ? (
        <div className="description lg:text-lg md:text-lg text-xs lg:px-20 md:px-20 px-12 -mt-24">{descriptions[hoveredIndex]}</div>
      ) : <p className="description2 lg:text-3xl md:text-3xl text-lg font-bold  lg:px-20 md:px-20 -mt-28" style={{color:"#35435F"}}>SSR Methodology</p>}
    </div>
  );
};
