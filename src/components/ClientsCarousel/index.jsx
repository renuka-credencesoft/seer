...
//   const handleNext = () => {
//     setActiveIndex((prevIndex) => (prevIndex + 1) % (isMobile ? cardCount : cardCount * 2));
//   };

//   const handlePrev = () => {
//     setActiveIndex((prevIndex) => (prevIndex - 1 + (isMobile ? cardCount : cardCount * 2)) % (isMobile ? cardCount : cardCount * 2));
//   };
...
//   useEffect(() => {
//     if (!isMobile && activeIndex === cardCount) {
//       setTimeout(() => {
//         setActiveIndex(0);
//       }, 500);
//     }
...
//       <div className="relative overflow-hidden -mt-24 lg:-mt-12 md:-mt-12">
//         <div
//           className={`flex transition-transform duration-500 ${activeIndex === cardCount || activeIndex === 0 ? 'transition-none' : ''}`}
//           style={{ transform: `translateX(-${(activeIndex % (isMobile ? cardCount : cardCount * 2)) * (100 / (isMobile ? 1 : 3))}%)` }}
//         >
//           {[...cards, ...cards].map((card, index) => {
//             const isMiddleCard = (index % (isMobile ? cardCount : cardCount * 2)) === ((activeIndex % (isMobile ? cardCount : cardCount * 2)) + getMiddleIndex()) % (isMobile ? cardCount : cardCount * 2);
//             return (
//               <div key={index} className={`flex-none ${isMobile ? 'w-full' : 'w-full md:w-1/3'} px-2`}>
//                 {isMiddleCard ? (
//                   <div className={`${isMobile ? 'w-full' : 'full-width-card'} mt-16`}>
...
//   const handlePrev = () => {
//     // Removed the code to handle previous scrolling
//   };
...
//       <div className="relative overflow-hidden -mt-24 lg:-mt-12 md:-mt-12">
//         <div
//           className={`flex transition-transform duration-500 ${activeIndex === cardCount * 2 ? 'transition-none' : ''}`}
//           style={{
//             transform: `translateX(-${(activeIndex % (isMobile ? cardCount : cardCount * 3)) * (100 / (isMobile ? 1 : 3))}%)`,
//           }}
//         >
//           {[...cards, ...cards, ...cards].map((card, index) => {
//             const isMiddleCard = (index % (isMobile ? cardCount : cardCount * 3)) === ((activeIndex % (isMobile ? cardCount : cardCount * 3)) + getMiddleIndex()) % (isMobile ? cardCount : cardCount * 3);
...
const ClientsCarousel = () => {
  ...
  return (
    <div className="carousel-container  -mb-38 relative bg-[#edeeff]" onMouseEnter={stopAutoScroll} onMouseLeave={startAutoScroll}>
      ...
      <button onClick={handlePrev} className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-gray-700 text-white p-3 rounded-full text-xl lg:mt-12 md:-mt-16  mt-20">
        <FaArrowLeft />
      </button>
      <button onClick={handleNext} className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gray-700 text-white p-3 rounded-full text-xl lg:mt-12 md:-mt-16 mt-20">
        <FaArrowRight />
      </button>
    </div>
  );
