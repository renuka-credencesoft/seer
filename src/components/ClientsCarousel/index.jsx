...
const ClientsCarousel = () => {
  ...
  return (
    <div
      className="carousel-container relative mb-10 bg-[#edeeff]"
      onMouseEnter={stopAutoScroll}
      onMouseLeave={startAutoScroll}
    >
      <p
        style={{ fontFamily: 'gothic-book' }}
        className="text-[#35435f] flex font-semibold align-center mt-14 justify-center text-xl md:text-3xl lg:text-3xl"
      >
