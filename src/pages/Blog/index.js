      ...
      {content == false ? (
        <div>
          <div className="BlogTopText">
            ...
            <p style={{fontFamily:'gothic-book, sans-serif'}}className="text-lg lg:text-2xl font-light py-4">
          ...
          <div className="BlogBottomText">
            <p style={{fontFamily:'gothic-book, sans-serif'}}className="text-lg lg:text-2xl font-semibold py-4">
        ...
        <div className="lg:px-20 md:px-20 sm:px-2">
          <p style={{fontFamily:'gothic-book'}} className="lg:text-5xl md:text-4xl text-xl font-bold text-center lg:px-40 md:px-20 sm:px-2">
            How can artificial intelligence help retailers forecast demand?
          </p>
          <div>
            <p style={{fontFamily:'gothic-book'}} className="lg:text-3xl text-lg font-bold  text-left pt-8">
              Are retailers on the verge of extinction?
            </p>
            <p style={{fontFamily:'roboto'}} className="lg:text-xl text-sm text-left py-6">
            ...
            <p style={{fontFamily:'roboto'}} className="lg:text-xl text-sm text-left">
          ...
          <div>
            <p style={{fontFamily:'gothic-book'}} className="lg:text-3xl text-xl font-bold text-left py-6">
              AI for retailers
            </p>
            <p style={{fontFamily:'roboto'}} className="lg:text-xl text-sm text-left pb-6">
            ...
            <p style={{fontFamily:'roboto'}} className="lg:text-xl md:text-lg text-sm ">
          ...
          <div>
            ...
            <p style={{fontFamily:'roboto'}} className="lg:text-xl text-sm text-left pt-4 ">
            ...
            <p style={{fontFamily:'roboto'}} className="lg:text-xl text-sm text-left py-4">
            ...
            <p style={{fontFamily:'roboto'}} className="lg:text-xl text-sm text-left pb-4">
