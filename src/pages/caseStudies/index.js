      ...
      <div className="flex flex-col items-center ">
        <div className="flex flex-col items-center pb-6 bg-[#edeeff]">
          ...
          <p
            ...
            className="text-left text-lg leading-7 tracking-normal p-4 sm:ml-16 sm:mr-16 text-[#35435f]"
          >
            Glassons chose Seer to automate and improve outcomes for this manual process. Each Sunday the store scans
            returns for the week. Using Seer’s API, the returns are uploaded to the Seer cloud and analysed by Stock Seer
            to determine the optimum selling stores, and propose transfers accordingly.
          </p>
          <p
            style={{ fontFamily: "roboto" }}
            className="text-left text-lg leading-7 tracking-normal p-4 sm:ml-16 sm:mr-16 text-[#35435f]"
        ...
        <div className="flex flex-col items-center bg-[#edeeff]  mb-[-80px] pb-32">
          ...
          <p
            ...
            className="text-left text-lg leading-7 tracking-normal p-4 sm:ml-16 sm:mr-16 text-[#35435f]"
          >
            Once again, we deployed Stock Seer to automate this manual process—generating an accurate, weekly sales
